    ...
    <main className='p=3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-5' onSubmit={handleSubmit}>
            <div className='flex flex-col gap-4 flex-1'>
                <input type='text' placeholder='Name' id='name' minLength='10'
                maxLength='62' required className='border p-3 rounded-lg' onChange={handleChange} value={formData.name}/>

                <input type='text' placeholder='Description' id='description' minLength='10' 
                maxLength='62' required className='border p-3 rounded-lg' onChange={handleChange} value={formData.description}/>

                <input type='text' placeholder='Address' id='address' minLength='10'
                 maxLength='62' required className='border p-3 rounded-lg' onChange={handleChange} value={formData.address}/>
             ...
             <div className='flex gap-6 flex-wrap'>
                ...
                </div>
                {
                    formData.offer && (
                        <div className='flex items-center gap-2'>
                    <input type='number' id='discountPrice' min='1' max='10000' required className='p-3 border border grey-300 rounded-lg' onChange={handleChange} value={formData.discountPrice}/>
                    <div className='flex flex-col items-center'>
