            ...
            <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
                <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                    <div className='flex items-center gap'>
                        ...
                        <input id='searchTerm' placeholder='Search...' className='border rounded-lg p-3 w-full' value={sidebarData.searchTerm} onChange={handleChange}/>
                    </div>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <select id='sort_order' className='border border-lg p-3' onChange={handleChange} defaultValue={'created_at_desc'}>
